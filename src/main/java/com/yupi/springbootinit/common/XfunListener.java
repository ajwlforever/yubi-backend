...
import com.yupi.springbootinit.config.dto.Xfun.XfunReceieveRequest;
...
//        msgDTO.setIndex(0);
//        msgs.add(msgDTO);
//        XfunListener xfunListener = XfunListener.builder()
...
//
//        try {
//            WebSocket webSocket = xfunListener.sendMsg("123", msgs, xfunListener );
//
//
